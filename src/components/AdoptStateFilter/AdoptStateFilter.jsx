...
const AdoptStateFilter = (props) => {
  ...
  return (
    ...
    <div className='filters-AdoptStateFilter'>
      <button className='Butt-type-AdoptStateFilter' onClick={props.onApply}><img className='AdoptStateFilter-img' src='./assets/img/logo/completado.png' alt=''></img>Aceptado</button>
